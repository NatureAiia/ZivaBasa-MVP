// Glitter Wrap — Originkit, adapted from the Framer TS source to plain React/JSX.
// Logic ported as-is; only type annotations and Framer-only plumbing were stripped.
...
export default function GlitterWrap(props) {
  ...
  useEffect(() => {
    ...
    const makeStar = () => ({
      x: 0, y: 0, z: 0, px: NaN, py: NaN, seed: 0, vmul: 1, colorIdx: 0, flashUntil: 0, nextFlash: 0,
    });
