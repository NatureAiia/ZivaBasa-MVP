...
/*
  ...
  low-bandwidth mode, API base URL). Relocated under Systems (was a standalone /app/settings
  page) so it sits alongside the new Users/Models tabs instead of being the only "system" page
  with its own top-level nav slot.
*/
